...
import { Table, Button, Input, Select, Space, Tabs, Tag, Switch, Image, message } from 'antd'
...
export default function CourseList() {
  ...
  return (
    <PageContainer
      title="课程管理"
      extra={activeTab === 'courses' ? <Button type="primary" icon={<PlusOutlined />} onClick={handleAdd}>新增课程</Button> : undefined}
    >
      <Tabs
        activeKey={activeTab}
