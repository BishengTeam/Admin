...
import { DeleteOutlined, EditOutlined, FolderOutlined, PlusOutlined, StopOutlined, CheckCircleOutlined } from '@ant-design/icons'
...
export default function CategoryTree({ categories, selectedKey, canWrite, onSelect, onCreate, onEdit, onStatus, onDelete }: CategoryTreeProps) {
  const tree = useMemo(() => buildCategoryTree(categories), [categories])

  const treeData: DataNode[] = [
    { title: '全部题目', key: 'all', icon: <FolderOutlined /> },
    ...toNodes(tree, tree, canWrite, { onEdit, onStatus, onDelete }),
  ]
